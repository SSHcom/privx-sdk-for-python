"""Generate Kubernetes kubeconfig via a PrivX API Proxy client credential.
...
- ``config.py`` next to this script must point to your PrivX instance and contain valid API
  client credentials.
...
def create_current_user_credential(
    ...
    payload = {
        ...
        "comment": "Generated by dev/get_kubeconfig_via_api_proxy.py",
        "target": {"id": target_id},
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  python3 your_path_to_the_script/get_kubeconfig_via_api_proxy.py --list-targets\n"
            "  python3 your_path_to_the_script/get_kubeconfig_via_api_proxy.py --api-target my-k8s-api\n"
            "  python3 your_path_to_the_script/get_kubeconfig_via_api_proxy.py --api-target my-k8s-api --create-if-missing "
